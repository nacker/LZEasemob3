 ...
 */
#pragma mark - 初始化导航栏Title，不同连接状态下Title显示内容不同
 ...
 */
#pragma mark - 对导航栏右侧的按钮（即视图右上角按钮）进行初始化，创建对应的popView
 ...
 */
#pragma mark - 点击了popView中具体某一行后的响应函数，popView初始化请参照上述 rightBarButtonClick: 函数
