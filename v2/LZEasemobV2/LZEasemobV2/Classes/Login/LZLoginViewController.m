...
{
    NSString *userSig = [GenerateTestUserSig genTestUserSig:username];
    
    AppDelegate *delegate = (AppDelegate *)[UIApplication sharedApplication].delegate;
    [delegate login:username userSig:userSig succ:nil fail:nil];
    
    
//    [[TUIKit sharedInstance] login:username userSig:userSig succ:^{
//
