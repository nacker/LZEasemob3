...
@interface LZCreateGroupViewController ()<UITextFieldDelegate, UITextViewDelegate>

@property (strong, nonatomic) UIView *switchView;
@property (strong, nonatomic) UIBarButtonItem *rightItem;
@property (strong, nonatomic) UITextField *textField;
@property (strong, nonatomic) LZTextView *textView;
...
@implementation LZCreateGroupViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"group.create.addOccupant", @"add members") style:UIBarButtonItemStyleDone target:self action:@selector(addContacts:)];
...
{
    if (_textView == nil) {
        _textView = [[LZTextView alloc] initWithFrame:CGRectMake(10, 70, 300, 80)];
        _textView.layer.borderColor = [[UIColor lightGrayColor] CGColor];
        _textView.layer.borderWidth = 0.5;
        _textView.layer.cornerRadius = 3;
        _textView.font = [UIFont systemFontOfSize:14.0];
        _textView.backgroundColor = [UIColor whiteColor];
        _textView.placehoder = NSLocalizedString(@"group.create.inputDescribe", @"please enter a group description");
...
//    }
//    
//    __weak LZCreateGroupViewController *weakSelf = self;
